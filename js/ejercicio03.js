...
//Test 1: 
console.log("nombreUsuario = Jorge, generoUsuario= H ")
saludarUsuario("Jorge", "H");
//Test 2: 
console.log("nombreUsuario = Maya, generoUsuario= M ")
saludarUsuario("Maya", "M");
//Test 3: 
console.log("nombreUsuario = Cristopher , generoUsuario= null ")
...
function login(username, password)
{
    ...
    {
        userValidation=false;
        console.log("Por favor verifica el usuario y la contraseña están incorrectos.")
    }
